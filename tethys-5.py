...
class SeismicApp:
    def __init__(self, root):
        ...
        self.bp_data = self.wt_data = None
    ...
    def select_data_combobox(self, window, px, py):
        ...
        options = ['Raw Data', 'Band Pass', 'Spectral Whitening', 'AGC', 'STALTA', 'Conv Ricker', 'Conv Ormsby',
    ...
    def _update_scene(self, selection):
        ...
        if selection == 'Raw Data':
            ...
            conv_ormsby_scene = self.scenes[self.scenes['tit'].str.contains('Ormsby')]
    ...
    def _save_filter_result(self, filter_type):
        """saved o resultado de um Filter na lista de cenas."""
...
# ========== INTERPRETATION =========================================================
    ...
    def open_interpretation_window(self):
        ...
        # modo_frame = Frame(self.win)
        # modo_frame.pack(pady=5)

        # Label(modo_frame, text="Modo:").pack(side=LEFT)
        # Radiobutton(modo_frame, text="Draw", variable=self.modo_interpretacao,
        # value="desenho").pack(side=LEFT)
        # Radiobutton(modo_frame, text="Edit", variable=self.modo_interpretacao,
